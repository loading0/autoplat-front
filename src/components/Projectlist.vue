<template>
    <section style="margin:35px">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
         <!-- padding-left: 10px; padding-top: 10px; -->
            <el-form :inline="true" :model="filters" @submit.native.prevent>
                ...
                <el-form-item>
                    <el-button type="primary" plain @click="getProjectList">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <!--编辑界面-->
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" append-to-body
        ...
        <!--新增界面-->
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" append-to-body style="width: 75%; left: 12.5%">
    ...
    export default {
        ...
        methods: {
            ...
            getProjectList() {
                ...
                var self = this;
                var params = { page: self.page, name: self.filters.name };
            ...
            handleChangeStatus: function (index, row) {
                ...
                if (row.status) {
                    disableProject( params).then(_data => {
                        let { msg, code, data } = _data;
                        self.listLoading = false;
                        if (code === '999999') {
                            self.$message({
                    ...
                    enableProject( params).then(_data => {
                        let { msg, code, data } = _data;
                        self.listLoading = false;
                        if (code === '999999') {
                            self.$message({
                ...
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        this.$confirm('确认提交吗？', '提示', {}).then(() => {
                            ...
                            updateProject(params).then(_data => {
                                let { msg, code, data } = _data;
