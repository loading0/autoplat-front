<template>
    <div style="margin:35px">
        ...
        <el-table :data="project" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
            ...
            <el-table-column prop="host" label="HOST" min-width="27%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="description" label="描述" min-width="25%" sortable show-overflow-tooltip>
            </el-table-column>
            <el-table-column prop="status" label="状态" min-width="7%" sortable>
        ...
        <!--编辑界面-->
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" append-to-body style="width: 60%; left: 20%">
        ...
        <!--新增界面-->
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" append-to-body style="width: 60%; left: 20%">
