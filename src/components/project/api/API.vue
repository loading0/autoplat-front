<template>
        <section>
            <el-row :span="24" class="row-title">
                ...
                <!--新增-->
                <el-dialog title="新增分组" :visible.sync="addGroupFormVisible" :close-on-click-modal="false" append-to-body style="width: 60%; left: 20%">
                ...
                <!--编辑父分组-->
                <el-dialog title="编辑分组" :visible.sync="editFirstGroupFormVisible" :close-on-click-modal="false" append-to-body style="width: 60%; left: 20%">
                    <el-form :model="editFirstGroupForm" label-width="80px"  :rules="editFirstGroupFormRules" ref="editFirstGroupForm">
                        <el-form-item label="分组名称" prop='secondFirstGroup'>
                            <el-input v-model.trim="editFirstGroupForm.secondFirstGroup" @input="change" auto-complete="off"></el-input>
                        </el-form-item>
                    </el-form>
                    <div slot="footer" class="dialog-footer">
        ...
        export default {
            ...
            methods: {
                ...
                getApiGroup() {
                    ...
                    getApiGroupList( params).then(_data => {
                    ...
                    this.$refs.editFirstGroupForm.validate((valid) => {
                        if (valid) {
                            ...
                            this.$confirm('确认提交吗？', '提示', {}).then(() => {
                                ...
                                console.log(params)
                                updateApiGroup( params).then(_data => {
                                    let {msg, code, data} = _data;
