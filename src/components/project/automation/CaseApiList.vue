<template>
    <section>
        <router-link :to="{ name: '用例列表', params: {project_id: this.$route.params.project_id}}" style='text-decoration: none;color: aliceblue;'>
            <el-button class="return-list" style="margin-right: 10px"><i class="el-icon-d-arrow-left" style="margin-right: 5px"></i>用例列表</el-button>
        </router-link>
        <el-button type="primary" @click.native="addOldApi" style="margin-right: 10px"><i class="el-icon-plus" style="margin-right: 5px"></i>已有接口</el-button>
        <router-link :to="{ name: '添加新接口'}" style='text-decoration: none;color: #000000;'>
            <el-button type="primary" style="margin-right: 10px"><i class="el-icon-plus" style="margin-right: 5px"></i>新建接口</el-button>
        </router-link>
        ...
        <el-dialog title="选择创建的API" :visible.sync="searchApiListVisible" :close-on-click-modal="false" append-to-body >
            <el-row :gutter="10">
                <el-col :span="6">
        ...
        <el-dialog title="测试结果" :visible.sync="TestResult" :close-on-click-modal="false" append-to-body>
