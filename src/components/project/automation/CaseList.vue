<template>
    <section>
        ...
        <el-dialog title="定时任务" :visible.sync="taskVShow"  :close-on-click-modal="false" append-to-body style="width: 70%; left: 15%">
        ...
        <el-dialog title="编辑" :visible.sync="editFormVisible" :close-on-click-modal="false" append-to-body style="width: 65%; left: 17.5%">
