<template>
    <section>
        ...
        <!--新增界面-->
        <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" append-to-body style="width: 65%; left: 17.5%">
        ...
        <el-dialog title="修改所属分组" :visible.sync="updateGroupFormVisible" :close-on-click-modal="false" append-to-body style="width: 65%; left: 17.5%">
